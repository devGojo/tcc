  ...
  return (
    <div className="principal">
      ...
      <div className="colecoes">
        ...
        <img className="confira" src={logo7} />
      </div>
      ...
      <div className="confiraaa">
        ...
        <div className="brinde">
          ...
          <h2 className="brinde3"> Na compra de duas peças ou mais leva um brinde </h2>


        </div>


        <img className="logo13" src={logo13}/>
        ...
        <div className="sobre">
          ...
          <p>        Somos uma empresa criada por 5 adolescentes <br></br> que surgiu por conta da dificil demanda de peças <br></br> ㅤ unicas presentes em culturas diferentes, <br></br> decidimos criar uma loja para ajudar pessoas a <br></br>  ㅤ terem acesso a uma cultura underground. <br></br>
